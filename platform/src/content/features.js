...
export const FEATURES = [
  ...
  { area: 'Learning', name: 'Modules 1, 2 and 4 as assignable lessons', status: 'tested' },
  { area: 'Learning', name: 'Modules 3, 5, 6, 7 and 8', status: 'planned', note: 'Specified in the curriculum; not built.' },
